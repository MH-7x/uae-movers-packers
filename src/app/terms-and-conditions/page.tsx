...
export const metadata: Metadata = {
  ...
  description:
    "RWahab Movers UAE Terms and Conditions. Our terms and conditions outline the rules and regulations for the use of Our Service.",
  alternates: {
    canonical: `${process.env.PUBLIC_URL}/terms-and-conditions`,
  },
  openGraph: {
    type: "website",
    locale: "en-AE",
    ...
    description:
      "RWahab Movers UAE Terms and Conditions. Our terms and conditions outline the rules and regulations for the use of Our Service.",
    images: `${process.env.PUBLIC_URL}/images/terms-and-conditions.jpg`,
...
const PrivacyPolicy: React.FC = () => {
  ...
  return (
    <section id="privacy-policy" className="max-w-4xl mx-auto mt-44 px-3">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to RWahab Movers UAE, Building No. 12 Street
            4, Al Yarmook Sharjah.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to RWahab Movers UAE, accessible
            from{" "}
            <a
      ...
      <ul>
        <li>
          <p>By email: rwahabmoversuae@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://rwahabmoversuae.com/contact-us"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://rwahabmoversuae.com/contact-us
            </a>
          </p>
        </li>
        <li>
