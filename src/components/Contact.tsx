...
function Contact({ title, desc }: { title: string; desc: string }) {
  return (
    <section className="mt-20 rounded-3xl bg-gradient-to-t from-primary to-violet-700 md:w-11/12 w-full mx-auto md:p-10 py-10 items-center md:pl-32 grid md:grid-cols-2 grid-cols-1 px-2">
