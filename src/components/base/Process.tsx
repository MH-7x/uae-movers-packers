...
import proImage from "../../../public/images/process.svg";
    ...
    <section className="md:w-11/12 mx-auto w-full min-h-screen mt-20 relative">
      ...
      {mobileSize ? (
        <div className="w-full grid grid-cols-1 gap-y-5 mt-24 relative px-4">
          <div className="w-full h-52 bg-white/90  shadow-lg shadow-slate-100 rounded-3xl items-center justify-center flex flex-col p-2 text-center">
            <svg
              ...
              strokeWidth={1.5}
              stroke="white"
              className="size-12 drop-shadow-lg ts mb-3 rounded-full bg-primary p-1.5"
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
        ...
        <div className="w-full  grid grid-cols-3 gap-x-4 mt-10 px-10 relative">
          <div className="w-[600px] h-80 border border-primary/50 rounded-3xl absolute top-1/2 left-1/2 -translate-x-1/2 md:flex hidden justify-items-end items-center flex-col -translate-y-1/2 -z-10">
            <Image
              src={proImage}
              width={300}
              height={320}
